  ...
  return (
    <section className="backendSettings">
      <header className="sectionHeader">
        ...
        <div>
          <h2 className="sectionTitle">백엔드 URL 설정</h2>
          <p className="sectionDescription">
            브라우저에서 사용할 API 주소를 직접 입력할 수 있습니다. Cloudflared Tunnel 주소나 로컬 개발 서버 주소를 넣고 연결을
            확인하세요.
          </p>
        </div>
      </header>
      ...
      <form className="backendSettingsForm" onSubmit={handleSubmit}>
        <label>
          ...
          <input
            ...
            placeholder="https://api.example.trycloudflare.com"
          />
        </label>
